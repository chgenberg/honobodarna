...
export const CabinsPage: FC<CabinsProps> = (p) => (
  <Layout title="Sjöbodar & koder" active="cabins" dryRun={p.dryRun}>
    ...
    {p.tab === "cyklar" ? (
      ...
      <>
        <details class="collapsible" style="max-width:680px;">
          <summary>
            Anpassa namn till ankomstlistan <span class="muted" style="font-weight:400; font-size:13px;">(engångsåtgärd)</span>
          </summary>
